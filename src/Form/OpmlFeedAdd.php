  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    if ($file = file_save_upload('upload', $validators, FALSE, 0)) {
      ...
      try {
        ...
        $this->logger('zhilagg')->warning('Failed to download OPML file due to "%error".', array('%error' => $e->getMessage()));
    ...
    $form_state->setRedirect('zhilagg.admin_overview');
  }
