...
/**
 * Provides an interface defining an zhilagg feed entity.
 */
interface FeedInterface extends ContentEntityInterface {
   ...
   *   The class instance that this method is called on.
   *
   * @see \Drupal\zhilagg\ItemsImporterInterface::delete()
   */
   ...
   *
   * @see \Drupal\zhilagg\ItemsImporterInterface::refresh()
   */
