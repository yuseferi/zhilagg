...
/**
 * Provides an interface defining an zhilagg item entity.
 */
interface ItemInterface extends ContentEntityInterface {

  /**
   * Returns the feed id of zhilagg item.
   *
   * @return int
   *   The feed id.
   */
  ...
  /**
   * Sets the feed id of zhilagg item.
   *
   * @param int $fid
   *   The feed id.
   *
   * @return \Drupal\zhilagg\ItemInterface
