...
use Drupal\zhilagg\ItemInterface;
use Drupal\Core\Entity\EntityTypeInterface;
use Drupal\Core\Field\BaseFieldDefinition;
use Drupal\Core\Url;

/**
 * Defines the zhilagg item entity class.
 *
 * @ContentEntityType(
 *   id = "zhilagg_item",
 *   label = @Translation("Zhilagg feed item"),
 *   handlers = {
 *     "storage" = "Drupal\zhilagg\ItemStorage",
 *     "storage_schema" = "Drupal\zhilagg\ItemStorageSchema",
 *     "view_builder" = "Drupal\zhilagg\ItemViewBuilder",
 *     "access" = "Drupal\zhilagg\FeedAccessControlHandler",
 *     "views_data" = "Drupal\zhilagg\ZhilaggItemViewsData"
 *   },
 *   uri_callback = "Drupal\zhilagg\Entity\Item::buildUri",
 *   base_table = "zhilagg_item",
 *   render_cache = FALSE,
 *   list_cache_tags = { "zhilagg_feed_list" },
 *   entity_keys = {
 *     "id" = "iid",
 *     "label" = "title",
 *     "langcode" = "langcode",
...
class Item extends ContentEntityBase implements ItemInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['iid']->setLabel(t('Zhilagg item ID'))
    ...
    $fields['fid'] = BaseFieldDefinition::create('entity_reference')
      ...
      ->setRequired(TRUE)
      ->setDescription(t('The zhilagg feed entity associated with this item.'))
      ->setSetting('target_type', 'zhilagg_feed')
