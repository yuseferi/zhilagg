 ...
 * @group zhilagg
 */
class ImportOpmlTest extends ZhilaggTestBase {
  ...
  public function openImportForm() {
    ...
    $this->drupalGet('admin/config/services/zhilagg/add/opml');
  ...
  public function validateImportFormFields() {
    $before = db_query('SELECT COUNT(*) FROM {zhilagg_feed}')->fetchField();

    $edit = array();
    $this->drupalPostForm('admin/config/services/zhilagg/add/opml', $edit, t('Import'));
    ...
    $after = db_query('SELECT COUNT(*) FROM {zhilagg_feed}')->fetchField();
  ...
  protected function submitImportForm() {
    ...
    $this->drupalPostForm('admin/config/services/zhilagg/add/opml', $form, t('Import'));
    ...
    db_delete('zhilagg_feed')->execute();
    ...
    $feeds_from_db = db_query("SELECT title, url, refresh FROM {zhilagg_feed}");
    $refresh = TRUE;
